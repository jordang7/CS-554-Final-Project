...
import {getFinancialItemWeekly,get_search_term} from "../actions/financialWeekly";
...
const FinancialItem = () => {
    ...
    const financialItem = useSelector((state) => state.financialItemWeekly.financialItem);
...
export default connect(mapStateToProps,{getFinancialItemWeekly})(FinancialItem);